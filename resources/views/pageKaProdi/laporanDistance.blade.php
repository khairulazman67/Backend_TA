...
?>
    ...
    <div class="w-full h-auto shadow-xl shadow-gray-400 mt-4">
        ...
        <div class="py-5 px-10">
            ...
            <h1 class="font-bold text-2xl">Laporan Pelanggaran Physical Distancing</h1>
            ...
            <div class="bg-primary-900 rounded-xl py-4 mt-4 px-4  font-bold ">
                <div class="flex flex-row justify-between">
                    ...
                    <div >
                        <form class="flex flex-row" action="{{url('/kaprodi/filterreportsocialdistancing')}}" method="post">
                        @csrf
                            <div class="flex">
                    ...
                    <div>
                        <form action="{{url('/kaprodi/printreportdistance')}}" method="post">
                            @csrf
                                    ...
                                    @foreach ($data as $i=>$dat)
                                        <tr class="whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                <div class="text-xl">{{$dat->jumlah}}</div>
                                            </td>
                                            <td>
