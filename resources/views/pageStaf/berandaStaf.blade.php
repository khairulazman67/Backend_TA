                                    ...
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <td class="flex px-2 py-4">
                                            ...
                                            <form action="{{url('staf/hapusPelanggaran/'.$dat->id)}}" method="post" onsubmit="return confirm('Apakah anda ingin melanjutkan penghapusan data?')">
                                                ...
                                                @csrf
                                                <button
                                                    class="px-3 py-1 text-xs text-white bg-red-700 ml-2 hover:bg-red-800 rounded-lg">Hapus</button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
                                ...
                                <tbody class="bg-white divide-y divide-gray-300 text-black">
                                    ...
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <td class="flex px-2 py-4">
                                            ...
                                            <form action="{{url('staf/hapusPelanggaranDistance/'.$dat->id)}}" method="post" onsubmit="return confirm('Apakah anda ingin melanjutkan penghapusan data?')">
                                                @method('delete')
                                                @csrf
                                                <button
                                                    class="px-3 py-1 text-xs text-white bg-red-700 ml-2 hover:bg-red-800 rounded-lg">Hapus</button>
